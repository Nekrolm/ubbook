...
Запустив тест под отладчиком и выведя беэтрейс, я получил нечто следующего вида
...
И это прекрасно. Хорошо. Теперь проблема ясна. Тесты, которые падали на ассертах также стадали, но от других глобальных переменных. 
