...
и [Visual Studio 2022](https://docs.microsoft.com/en-us/cpp/standard-library/valarray-operators?view=msvc-170#op_star) имеет разные типы возвращаемого значения.
...
2. Если вы не знаете, что имеет дело с proxy классом, возможны разные неприятные последствия, включая определённое, но странное, или неопределённое поведение
